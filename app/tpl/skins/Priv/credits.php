...
<html lang="en-US">
	...
	<body>
		<div class="center content round">
			...
			<div class="cbb clear fix blue ">
				<h2 class="title">{hotelName} Credits <span class="habblet-close"></span></h2>
				<div style="padding: 15px;">
					<p><b>{hotelName} credits are free!</b>
					<br />Our credits are free and always will be!</p>
